  ...
  var process = function () {
    ...
    languages.forEach(function (language) {
      ...
      templates.forEach(function (page) {
        ...
        var name = file.lastSegment(page.replace(ext, ''));
        var context = _.extend({}, data, {language: language, i18n: i18n}, pageObj.context, data[name + '-' + language], data[name], {no_lang_name: name});
